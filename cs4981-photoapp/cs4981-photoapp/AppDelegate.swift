...
//
// Need to add description in info with the key "Privacy - Photo Library Usage Description"
    ...
    func gotoVC() {
        DispatchQueue.main.async(execute: { () -> Void in
            ...
            if let window = self.window {
                ...
                let mainView = ViewController() // this is where this code connect to other code
